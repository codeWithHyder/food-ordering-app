...
const BodyContainer = () => {
    ...
    const fetchData = async ()=>{
        try {
            ...
            // console.log(dat);
            setListOfRestaurants(dat.data.cards[1].card.card.gridElements.infoWithStyle.restaurants);
            setAfterFilterList(dat.data.cards[1].card.card.gridElements.infoWithStyle.restaurants);
...
// console.log(listOfRestaurants + 'is list from api')

    return (
        <div className="flex flex-wrap mx-14 mt-[6rem] ">
